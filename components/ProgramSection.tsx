...
export function ProgramSection() {
  return (
    ...
    >
        <div 
            className="absolute inset-0 z-0 h-16 bg-linear-to-t from-[#f5e8e4] to-[#fdf8f2]"
            ...
            {program.map((item, i) => (
              ...
              >
                ...
                <div className="flex items-start gap-6 w-full md:hidden">
                  <div className="flex flex-col items-center pt-1" style={{ minWidth: "5.5rem" }}>
                    <span
                      style={{
                  ...
                  {/* Dot */}
                  <div className="relative flex flex-col items-center" style={{ marginTop: "0.3rem" }}>
                    <div
                      className="w-3 h-3 rounded-full border-2 flex-shrink-0"
                      style={{ background: "#FDF8F2", borderColor: "#8B4D5E" }}
                    />
                    {i < program.length - 1 && (
                      <div className="w-px flex-1 mt-1 min-h-[3.5rem]" style={{ background: "rgba(139,77,94,0.18)" }} />
                    )}
                  </div>
                ...
                <div className={`hidden md:flex w-full items-start gap-8 ${i % 2 === 0 ? "flex-row" : "flex-row-reverse"}`}>
                  <div className={`flex-1 pb-10 ${i % 2 === 0 ? "text-right pr-8" : "text-left pl-8"}`}>
                    <p
                      style={{
                        fontFamily: "'Montserrat', sans-serif",
                        fontSize: "0.8rem",
                  ...
                  <div
                    ...
                    style={{ width: "0px", marginTop: "0.3rem" }}
                  >
                    <div
